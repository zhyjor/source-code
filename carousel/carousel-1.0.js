...
var rollWidget = (function (arg) {
        ...
        objDOM.addEventListener('touchstart', function (event) {
            ...
            $("#" + arg.renderTo + " figure").css("color", arg.focusColor);
        ...
        function calRoationOffset() {
            ...
            // console.log("ret:"+ret+"  theta:"+carousel.theta+ " roationffset:"+roationffset);
            return ret;
        }
        ...
        var init = function init() {
            ...
            var item = [];
            defalutCount = obj.children().length;
            /*item 个数*/
            obj.children().each(function (i, n) {
                item.push(n.innerHTML);
            });
            obj.html("");
            var newHtml = "";

            /*补偿超过40*/
            /*  var modLen = 40 % defalutCount;
             var divLen = 40 / defalutCount;
             completCount = (parseInt(divLen) + parseInt(modLen > 0 ? 1 : 0)) * defalutCount;
             for (var i = 0; i < completCount; i++) {
             var idx = i % defalutCount;
             newHtml += "<figure>" + item[idx] + "</figure>";
             }
             */
            completCount = 40;
            // var modLen = 40 % defalutCount;
